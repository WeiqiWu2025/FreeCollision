...
ConcurScatter_threeTags_Tag1 = [0.0386152173913044;0.0240195652173913;0.0182260869565217;0.0177086956521739];
ConcurScatter_threeTags_Tag2 = [0.0317695652173913;0.0140130434782609;0.00613043478260870;0.00506086956521739];
ConcurScatter_threeTags_Tag3 = [0.0383695652173913;0.0227586956521739;0.0165934782608696;0.0158565217391304];
...
%% BER plot
vals_BER = [FreeCollision_threeTags(1:end-1),Mecha_threeTags(1:end-1),MultiRider_threeTags(1:end-1),ParaFi_threeTags(1:end-1),ConcurScatter_threeTags];
vals_TP = [TP_FreeCollision_threeTags(1:end-1),TP_Mecha_threeTags(1:end-1),TP_MultiRider_threeTags(1:end-1),TP_ParaFi_threeTags(1:end-1),TP_ConcurScatter_threeTags];

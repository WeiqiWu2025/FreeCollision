function [estBaseH] = survey_FreeCollision_funcFindClosestElements2Target_elevenTags(channelSet,target)

tmp_min = abs(target-channelSet(1:11));
len = length(channelSet);
estBaseH = ones(11,1);
estBaseH = channelSet(1:11);
                                ...
                                for idx9 = (idx8+1):len
                                    for idx10 = (idx9+1):len
                                        for idx11 = (idx10+1):len
                                            idxSet = [idx1,idx2,idx3,idx4,idx5,idx6,idx7,idx8,idx9,idx10,idx11];

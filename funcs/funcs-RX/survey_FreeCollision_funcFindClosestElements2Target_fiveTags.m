function [estBaseH] = survey_FreeCollision_funcFindClosestElements2Target_fiveTags(channelSet,target)

tmp_min = abs(target-channelSet(1:5));
len = length(channelSet);
estBaseH = ones(5,1);
estBaseH = channelSet(1:5);
...
for idx1 = 1:len
    for idx2 = (idx1+1):len
        for idx3 = (idx2+1):len
            for idx4 = (idx3+1):len
                for idx5 = (idx4+1):len
                    idxSet = [idx1,idx2,idx3,idx4,idx5];

function [estBaseH] = survey_FreeCollision_funcFindClosestElements2Target_tenTags(channelSet,target)

tmp_min = abs(target-channelSet(1:10));
len = length(channelSet);
estBaseH = ones(10,1);
estBaseH = channelSet(1:10);
                            ...
                            for idx8 = (idx7+1):len
                                for idx9 = (idx8+1):len
                                    for idx10 = (idx9+1):len
                                        idxSet = [idx1,idx2,idx3,idx4,idx5,idx6,idx7,idx8,idx9,idx10];

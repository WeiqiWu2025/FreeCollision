function [estBaseH] = survey_FreeCollision_funcFindClosestElements2Target_nineTags(channelSet,target)

tmp_min = abs(target-channelSet(1:9));
len = length(channelSet);
estBaseH = ones(9,1);
estBaseH = channelSet(1:9);
                ...
                for idx5 = (idx4+1):len
                    for idx6 = (idx5+1):len
                        for idx7 = (idx6+1):len
                            for idx8 = (idx7+1):len
                                for idx9 = (idx8+1):len
                                    idxSet = [idx1,idx2,idx3,idx4,idx5,idx6,idx7,idx8,idx9];

...
%% ConcurScatter
ConcurScatter_low_threeTags_Tag1 = [0.311407608695652;0.296215942028986;0.294307246376812];
ConcurScatter_low_threeTags_Tag2 = [0.423760144927536;0.411060869565217;0.409382608695652];
ConcurScatter_low_threeTags_Tag3 = [0.326981884057971;0.310246014492754;0.308062681159420];

ConcurScatter_medium_threeTags_Tag1 = [0.0400239130434783;0.0367416666666667;0.0363985507246377];
ConcurScatter_medium_threeTags_Tag2 = [0.0393126811594203;0.0349452898550725;0.0343503623188406];
ConcurScatter_medium_threeTags_Tag3 = [0.0405739130434783;0.0368101449275362;0.0362677536231884];

ConcurScatter_high_threeTags_Tag1 = [0.0207923913043478;0.0189873188405797;0.0188536231884058];
ConcurScatter_high_threeTags_Tag2 = [0.00847173913043478;0.00541775362318841;0.00502934782608696];
ConcurScatter_high_threeTags_Tag3 = [0.0192452898550725;0.0170181159420290;0.0167489130434783];
...
%% plot BER
vals_BER_low = [BER_FreeCollision_low(2:end-1),BER_Mecha_low(2:end-1),BER_MultiRider_low(2:end-1),BER_ParaFi_low(2:end-1),BER_ConcurScatter_low];
vals_BER_medium = [BER_FreeCollision_medium(2:end-1),BER_Mecha_medium(2:end-1),BER_MultiRider_medium(2:end-1),BER_ParaFi_medium(2:end-1),BER_ConcurScatter_medium];
vals_BER_high = [BER_FreeCollision_high(2:end-1),BER_Mecha_high(2:end-1),BER_MultiRider_high(2:end-1),BER_ParaFi_high(2:end-1),BER_ConcurScatter_high];


%% plot Throughput
vals_TP_low = [TP_FreeCollision_low(2:end-1),TP_Mecha_low(2:end-1),TP_MultiRider_low(2:end-1),TP_ParaFi_low(2:end-1),TP_ConcurScatter_low];
vals_TP_medium = [TP_FreeCollision_medium(2:end-1),TP_Mecha_medium(2:end-1),TP_MultiRider_medium(2:end-1),TP_ParaFi_medium(2:end-1),TP_ConcurScatter_medium];
vals_TP_high = [TP_FreeCollision_high(2:end-1),TP_Mecha_high(2:end-1),TP_MultiRider_high(2:end-1),TP_ParaFi_high(2:end-1),TP_ConcurScatter_high];
...
xlabel('The SNR of backscattered signals (dB)','FontSize',14,'FontName','Times New Roman');
